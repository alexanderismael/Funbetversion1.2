...
import bd from './bd';
import {miPerfilStack,calendarioStack} from '../Screennames';
...
export default class Login extends React.Component {
    ...
    loginUser = (email,password) => {
      ...
      .then(this.setState({usuario:firebase.auth().currentUser.uid}),
       ...
       ()=>this.props.navigation.navigate(/*'miPerfilStack'*/'calendarioStack'))          
     ...
     async loginWithFacebook(){
      ...
      alert('Bienvenido'+this.state.usuario),this.props.navigation.navigate(/*'miPerfilStack'*/'calendarioStack'))
